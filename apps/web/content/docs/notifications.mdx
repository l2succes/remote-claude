...
description: The notification system ensures you're immediately informed when remote Claude Code tasks complete, fail, or require attention. It supports multiple channels and can be configured for different types of events.
section: Advanced
order: 4
---
