---
title: Remote Claude Persistent Sessions Guide
description: This guide shows you how to run Claude Code in persistent sessions that survive host machine shutdowns using GitHub Codespaces.
section: Advanced
order: 3
---
