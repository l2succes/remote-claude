---
title: Remote Claude Setup Guide
description: This comprehensive guide will walk you through setting up Remote Claude from scratch, including all authentication requirements and configuration options.
...
2. Configure [notifications](/docs/notifications) for task updates
